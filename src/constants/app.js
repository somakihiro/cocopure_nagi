...
export const Menus = [
  ...
  },
  {
    ...
    price: "13,000",
    description:
      "クレンジング後、角質ケアで古い老化角質を除去していきます。その後、特に毛穴で気になるお鼻まわりを中心に、毛穴に詰まった汚れ（＝角栓）をエクストラクションという手技で取り除いた後、ターンオーバーの促進に効果的なジェルパックを施します。そしてニキビ、肌荒れ、シミ、シワに効果的なクレイパック。フェイシャルマッサージで滞りを流した後、LEDライト照射とパックでお肌を鎮静化します。トーンアップしたつるつるのお肌・すっきりとしたお顔まわりへと導きます。<br />・毛穴エクストラクションについて<br />エクストラクションはヨーロッパ、アメリカのエステサロンでは、メジャーに取り入れられている手技による毛穴洗浄になります。日本ではまだ少数のサロンでしか受ける事ができない毛穴を根本からきれいにする為の施術です。3、4週間おきに施術可能で3-10回（個人差があります）の施術で汚れがたまりにくい引き締まった毛穴へと導いていきますので継続しての施術をお薦めします。場合により、痛みを伴う方もいらっしゃいますので（個人差があります）強さ加減を伺いながら施術させていただきます。",
    treatmentContent:
